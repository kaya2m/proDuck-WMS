...
const supplierValidationRules = () => {
  return [
    body("name").notEmpty().withMessage("Tedarikçi adı gerekli.").trim(),

    body("contactPerson.name").optional().trim(),

    body("contactPerson.title").optional().trim(),
    ...
    body("bankDetails.iban")
      ...
      .withMessage("IBAN formatı geçerli değil.")
      .trim(),

    body("bankDetails.swiftCode").optional().trim(),

    body("products")
      .optional()
      .isArray()
      .withMessage("Ürünler bir dizi olmalıdır.")
      .custom((products) =>
        products.every((id) => /^[a-fA-F0-9]{24}$/.test(id))
      )
      .withMessage("Geçerli ürün ID'leri girin."),

    body("status")
      .optional()
      .isBoolean()
      .withMessage("Durum değeri boolean olmalıdır."),
    ...
    body("deliveryLeadTime")
      .optional()
      .isInt({ min: 0 })
      .withMessage("Teslim süresi 0 veya daha büyük bir tam sayı olmalıdır."),
    ...
    body("tags")
      ...
      .withMessage("Etiketler string olmalıdır."),
