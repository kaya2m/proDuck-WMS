...
router.post('/', authenticateToken, customerValidationRules(), validate, async (req, res) => {
    const { customerCode, name, contact, billingAddress, shippingAddress, postCode, companyName, taxNumber, taxOffice, idNumber, notes, status } = req.body;
    try {
...
router.put('/:id', authenticateToken, customerValidationRules(), validate, async (req, res) => {
    const { customerCode, name, contact, billingAddress, shippingAddress, postCode, companyName, taxNumber, taxOffice, idNumber, notes, status } = req.body;
    try {
